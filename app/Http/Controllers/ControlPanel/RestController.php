...
class RestController extends Controller
{
    ...
    {   
        ...
        return redirect('restaurants')->with('succeess','inserted');
    }
    ...
    public function edit($id)
    {
        $districts =District::with('city')->get();
        $restaurant = Restaurant::find($id);
        return view('pages/addNewRest', ['restaurant' => $restaurant,'districts'=>$districts]);
    }
    ...
    { 
        ...
        return redirect('restaurants')->with('succeess','updated');
    }
