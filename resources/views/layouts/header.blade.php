...
<html lang="en">
    ...
    <body class="font-opensans iconcolor rtl">
        ...
        {{-- restaurants --}}
            <script type="text/javascript">
                $('#deleteModal').on('show.bs.modal', function (event) {
                    var button = $(event.relatedTarget);
                    var id = button.data('id');
                    $('#deleteForm').attr("action", "{{url('restaurants')}}" + "/" + id);
                });
            </script>
            <script type="text/javascript">
                $('#disableModal').on('show.bs.modal', function (event) {
                    var button = $(event.relatedTarget);
                    var id = button.data('id');
                    $('#activeForm').attr("action", "{{url('activeRest')}}" + "/" + id);
                });
            </script>
        ...
        {{--add new price group --}}
            <script type="text/javascript">
                $('#addModalGroup').on('show.bs.modal', function (event) {
                    var button = $(event.relatedTarget);
                    var id = button.data('id');
                    $('#addForm').attr("action", "{{url('storeGroup')}}" + "/" + id);
                });
            </script>
            <script type="text/javascript">
                $('#deleteModalPrice').on('show.bs.modal', function (event) {
                    var button = $(event.relatedTarget);
                    var id = button.data('id');
                    $('#deleteGroup').attr("action", "{{url('PricingGroup')}}" + "/" + id);
                });
            </script>
            <script type="text/javascript">
                $('#adminAddModalGroup').on('show.bs.modal', function (event) {
                    var button = $(event.relatedTarget);
                    var id = button.data('id');
            ...
            <script type="text/javascript">
                $('#admindeleteModalPrice').on('show.bs.modal', function (event) {
                    var button = $(event.relatedTarget);
                    var id = button.data('id');
                    $('#deleteGroup').attr("action", "{{url('admin/PricingGroup')}}" + "/" + id);
                });
            </script>
        
        {{--admin/restaurants --}}
            <script type="text/javascript">
                $('#deleteAminRest').on('show.bs.modal', function (event) {
                    var button = $(event.relatedTarget);
                    var id = button.data('id');
            ...
            <script type="text/javascript">
                $('#disableAminRest').on('show.bs.modal', function (event) {
                    var button = $(event.relatedTarget);
                    var id = button.data('id');
        ...
        {{-- groups --}}
            <script type="text/javascript">
                $('#deleteModalGroup').on('show.bs.modal', function (event) {
                    var button = $(event.relatedTarget);
                    var id = button.data('id');
                    $('#deleteGroup').attr("action", "{{url('admin/groups')}}" + "/" + id);
                });
            </script>
            <script type="text/javascript">
                $('#disableModalGroup').on('show.bs.modal', function (event) {
                    var button = $(event.relatedTarget);
                    var id = button.data('id');
                    $('#activeGroup').attr("action", "{{url('admin/activeGroup')}}" + "/" + id);
                });
            </script>
        ...
        {{-- users --}}
            <script type="text/javascript">
                $('#disableModaluser').on('show.bs.modal', function (event) {
                    var button = $(event.relatedTarget);
                    var id = button.data('id');
                    $('#activeForm').attr("action", "{{url('admin/activeUser')}}" + "/" + id);
                });
            </script>
            <script type="text/javascript">
