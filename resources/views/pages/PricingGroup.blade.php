 @extends('layouts.header')
                                    ...
                                    @else
                                        @foreach ($groups as $group)
                                            <tr>
                                                ...
                                                <!--<td>-->
                                                <!--    <button data-id="{{$group->cell_id}}" type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteModalPrice">حذف</button>-->
                                                <!--</td>-->
                                            </tr>
                                        @endforeach
                                    @endif
    ...
    <div class="modal fade" id="deleteModalPrice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
