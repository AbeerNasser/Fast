                                        ...
                                        @foreach ($restaurants as $restaurant)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" data-id="{{$restaurant->id}}" class="btn btn-success mt-1" data-toggle="modal" data-target="#disableAminRest">{{$restaurant->temp_disable==1 ? 'تم التعطيل': 'تعطيل مؤقت'}}</button>
                                                    <button type="button" data-id="{{$restaurant->id}}" class="btn btn-success mt-1" data-toggle="modal" data-target="#deleteAminRest">حذف</button>
                                                </td>
                                            </tr>
...
<!-- Modal -->
    <div class="modal fade" id="deleteAminRest" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<!-- Disable Modal -->
    <div class="modal fade" id="disableAminRest" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
